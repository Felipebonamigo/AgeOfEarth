...
- `npx tsx scripts/hudshot.ts http://localhost:4173/ docs/art/g4-g8-hud.png [pt|en]` — captura do HUD de cenário (m6: barra da guarda G4, Colosso com nome G8 no painel e no tooltip); falha se algum dos três faltar
