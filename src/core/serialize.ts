...
export function serialize(state: GameState): string {
  ...
  const out = {
    ...
    winner: s.winner, gameOver: s.gameOver, rng: s.rng.s, ceasefireUntil: s.ceasefireUntil, ceasefireBy: s.ceasefireBy, scenario: s.scenario ?? null, koth: s.koth ?? null, relics: s.relics, aiRound: s.aiRound,
  };
