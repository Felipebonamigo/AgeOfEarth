...
export const UNITS: Record<string, UnitDef> = {
  ...
  basileus: { id: 'basileus',
    name: 'Rei', plural: 'Reis', icon: '👑', cls: 'hero', unique: true,
    cost: {}, hp: 320, attack: 10, attackType: 'hack', armor: { hack: 0.3, pierce: 0.3, crush: 0.2 },
    range: 0.7, speed: 2.4, los: 9, trainTime: 0, pop: 0, radius: 0.32,
    tags: ['hero', 'human', 'military', 'infantry', 'king'], bonus: {}, building: null, age: 0,
    desc: 'Regicídio: se o rei morrer, o reino cai. Guarneça-o num Centro Cívico ou numa Fortaleza.',
  },
  militia: { id: 'militia',
  ...
  // ---------------- Heróis ----------------
  jason: { id: 'jason',
    name: 'Jasão', plural: 'Jasão', icon: '🦁', ability: 'war_cry', cls: 'hero', unique: true,
  ...
  odysseus: { id: 'odysseus',
    name: 'Odisseu', plural: 'Odisseu', icon: '🏹', ability: 'cunning', cls: 'hero', unique: true,
  ...
  heracles: { id: 'heracles',
    name: 'Héracles', plural: 'Héracles', icon: '💪', ability: 'titanic_blow', cls: 'hero', unique: true,
  ...
  achilles: { id: 'achilles',
    name: 'Aquiles', plural: 'Aquiles', icon: '🔥', ability: 'fury', cls: 'hero', unique: true,
  ...
  perseus: { id: 'perseus',
    name: 'Perseu', plural: 'Perseu', icon: '🪞', ability: 'mirror_shield', cls: 'hero', unique: true,
