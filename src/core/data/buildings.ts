...
export const BUILDINGS: Record<string, BuildingDef> = {
  ...
  tower: { id: 'tower',
    ...
    territory: 3, los: 12, attack: 9, attackType: 'pierce', range: 8, age: 0, hotkey: 'X', limit: 20, garrison: 5,
  ...
  gate: { id: 'gate',
    name: 'Portão', icon: '🚪', cost: { wood: 40 }, hp: 900, w: 1, h: 1, buildTime: 12, armor: { hack: 0.6, pierce: 0.95, crush: 0 },
    age: 0, hotkey: 'K', gate: true, wall: true, desc: 'Trecho de muralha que deixa suas unidades e aliados passarem, mas bloqueia inimigos.',
  },
  fortress: { id: 'fortress',
    ...
    trains: ['hoplite', 'toxotes', 'hypaspist', 'hetairoi', 'myrmidon'], age: 2, hotkey: 'V', limit: 4, military: true, garrison: 20,
...
export const BUILD_MENU: string[] = [
  ...
  'academy', 'tower', 'wall', 'gate', 'fortress', 'town_center', 'wonder_zeus', 'wonder_artemis', 'wonder_colossus', 'titan_gate',
];
