...
- **Micenas no Fácil:** a ficha pedia IA normal via `ai` [G16], que não existe. Um paliativo (Micenas com +1000 de cada no Fácil) foi medido e descartado: Micenas passava a enfrentar Oceano sozinha e a passiva do Fácil não perdia em 22 min. Micenas fica IA fácil nas três dificuldades.
- **Ondas e escoltas a 30 tiles**, sempre pelo sul (`angle: 2`, `distance: 30`). A 22 tiles do CC (e nos ângulos 1 e 3) a origem caía na crista e a espiral achava casas dentro da muralha. A escolta da maré (Hidra e 2 hipeus a cada 60 s, só na maré alta) vai à crista na 1ª maré (`mare_escolta1`) e ao Centro Cívico nas outras (`mare_escolta`); toda invasão contra o CC exige o CC de pé (sem invasão sem alvo).
...
- **Falas acrescentadas** (tom da §1.2, ≤ 200 caracteres): Jasão sobre a brecha, a Pítia com as teclas do Portal (V e B, mecânica nova) e explicando as marés, o recuo ("não o persiga até a praia") e o Raio para a última maré; o Batedor nas duas ondas; Oceano na 2ª e na 3ª maré; Prometeu ao atender; a Pítia se Jasão cair; Rei Atreu se a Liga cair; Jasão quando um portão cai e quando a Hidra morre. O `outro` da ficha foi dividido em dois parágrafos, sem mudar o texto.
...
| m8 | Oceano derruba o CC: **derrota** em 12–20 min. **Medido (produção, `npx tsx scripts/missions.ts 22 m8_oceano`):** derrota aos 15m47s / 18m53s / 12m56s (Fácil / Normal / Difícil). Quem derruba o CC da Argos parada: a Liga durante o 1º recuo (Fácil), Oceano na 2ª maré (Normal) e a Liga com a escolta da 1ª maré (Difícil); com a passiva padrão de 14 min, em jogo no Fácil e no Normal | IA econômica, 8 torres no sul, Raio em Oceano ao surgir, heróis em `attack` na tag `oceano`. **Produção:** defesa (`hold`), cidadãos até 45, filas militares com os quatro heróis, a brecha fechada com muralha, 8 torres atrás das passagens, a Hidra de Lerna com dois heróis aos 4 min, Jasão guardado atrás do CC, heróis em Oceano na maré alta e todos para dentro da muralha na baixa, Raio na 3ª maré (detalhes abaixo); variante "titãs" | 30–35 min (§4) · janela estrita 21m–45m30s (o "13–25" desta linha era a estimativa do rascunho, com uma luta só). **Medido:** vitória aos 23m56s / 23m41s / 23m45s; marés aos 10 min, ~16–17 min e ~23 min; `lerna` e `jasao` cumpridos nas três. **Variante "titãs"** (Prometeu pelo Portal; exige `prometeu`): 25m02s / 23m45s / 23m51s, com `titas` cumprido nas três e Prometeu por volta dos 11 min. |
