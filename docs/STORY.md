...
- **devorar** em três gatilhos (`devorar`, `devorar_hades`, `devorar_poseidon`), cada um só com o CC do alvo de pé (o `forEachPlayer` da ficha gerava invasão sem alvo quando um CC caía, e a checagem (f) falhava), todos vindos do lado do Campo (ângulos 1, 7 e 5).
- **Segredo de Perseu com [G13]** ("Perseu dá o golpe final em Cronos", `kills … by { tag: "perseu" }`) no lugar de "Perseu vivo": o Raio e os golpes de outros não contam, e a fala final é de Perseu quando o golpe é dele e de Zeus quando não.
...
- **Passiva:** derrota aos **46m39s / 20m55s / 8m45s** (Fácil / Normal / Difícil). No Fácil, Cronos sai aos 30 min e a Nova Argos cai aos 46m39s (Hades perde o CC aos 41m51s); no Normal e no Difícil quem derruba a cidade parada é o Culto, antes de Cronos, e os irmãos seguram as próprias casas. A §7.2 previa "os aliados seguram; aos 25 min Cronos surge e derruba a Nova Argos: derrota em 30–40 min".
