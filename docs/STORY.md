...
- **A escolta não se resolve em 2 minutos** (as mudanças principais). Medido com o JSON da ficha: a IA do jogador vendia madeira e comida no Mercado, comprava a trégua aos 2m45s e vencia aos **3m34s**; e, sem Mercado nenhum, a escolta chegava a Odisseu aos 68 s e o trazia para casa aos **2m03s** (Fácil e Normal), antes da 1ª caça — a caça é um `raid` que vai ao ponto onde Odisseu estava e não o persegue, e o vau (5 cavaleiros atrás dele) ficava para trás. Odisseu sozinho ainda andava até Argos durante a trégua inicial de 45 s. Três mudanças fecham isso, cada uma com a sua fala:
  ...
  - **Os vigias das fogueiras caçam Odisseu na estrada:** depois do encontro, com as fogueiras acesas, fora da praia (14 tiles) e longe do CC (16), a cada 20 s nascem 8 cavaleiros (3 hetairoi e 5 hipeus; 6/8/12 com `scaled`) a 14 tiles dele, com ordem `attack` nele (`spawn` + `order`, tag `cacadores`) — eles o perseguem, e a escolta tem de ficar entre eles e Odisseu. Não nascem na trégua comprada (contador `tregua_s`) nem com as duas torres caídas. O mesmo caminho direto agora perde Odisseu aos 1m20s–1m23s nas três dificuldades.
  ...
  - Assim há três saídas: esperar o Emissário (o roteiro), derrubar as duas fogueiras (fim da caça e dos caçadores da estrada; é o segredo `sinais`) ou levar uma escolta grande o bastante para os caçadores. O `vau` continua o da ficha (uma vez, 5 cavaleiros a 16 tiles a leste).
...
- **Falas acrescentadas** (tom da §1.2, ≤ 200 caracteres): Pítia aos 4 s (Odisseu espera na praia: mande 3 soldados), Odisseu quando o afastam da praia, Pítia no encontro (Astúcia de Odisseu, tecla Q), Pítia no Fácil (a torre do sul caiu com a chuva), Batedor aos 130 s (tochas) e nos primeiros caçadores da estrada, Odisseu aos 150 s (as fogueiras), o Emissário na oferta e Hera na queda do Heraion. HUD: a trégua inicial (46 s, porque ela começa no 1º segundo) e o relógio do Emissário.
