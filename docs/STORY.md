...
- **Com [G13] ✅ — "Perseu dá o golpe final":** um segredo com `"done": { "kills": { "player": 0, "type": "cronus", "by": { "tag": "perseu" } }, "gte": 1 }` (o Raio, que só tira metade da vida de um Titã, e os golpes de outros não contam) e uma fala própria de Perseu no lugar da de Zeus quando for ele.
