...
| 4.2 | ✅ Reconexão por instantâneo: quem cai entra na mesma sala com o mesmo nome, recebe estado + comandos futuros do anfitrião e volta ao lockstep (teste unitário com 3 pares e playtest de dois navegadores). Pendente: pausa automática por queda (hoje os outros seguem) | A | 11–13 |
