...
| 5.2 | ✅ Veterania (3 patentes por abates: +10% ataque/vida cada; estrelas na unidade e no painel). ✅ Habilidades ativas dos 5 heróis (Grito dos Argonautas, Astúcia, Golpe Titânico, Fúria, Escudo Espelhado) com recarga, botão no painel e tecla Q; a IA as usa em combate. Pendente: relíquias, formações de exército | A | 16–22 |
