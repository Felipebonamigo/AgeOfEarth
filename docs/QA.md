...
| `npx tsx scripts/maps/fairness.ts <mapa ou id> [min] [sementes=1-16] [deuses=zeus]` | Justiça por início: IA×IA com o **mesmo deus em todos os inícios** (espelho; deuses diferentes escondem o viés de posição), vitórias e minutos das idades por início; a última linha aplica o critério (≥ 16 sementes, nenhum início/time com > 65 % das decididas). Referência 25/09/2026 (35 min, Normal, sementes 1–16): **Estreito** Zeus 8 × 6 (2 sem vencedor), Poseidon 6 × 10 → 14 × 16, dentro do critério; Heroica 15,4–16,3, Mítica 19,6–21 nos dois inícios. **Egeu** 2v2 por times, 4× Zeus: **norte 8, sul 0**, 8 sem vencedor — **defeito aberto** (viés de posição do motor/IA com orientação absoluta; o mapa é exatamente simétrico): não anunciar o Egeu como justo para 2v2 ranqueado até ficar dentro do critério | ~4 min (4 processos) |
